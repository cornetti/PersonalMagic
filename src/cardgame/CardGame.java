...
public class CardGame {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0;i<8; i++) deck.add(new Cancel());               //tested
        for (int i=0;i<8; i++) deck.add(new NorwoodRanger());        //tested
        for (int i=0;i<8; i++) deck.add(new BronzeSable());          //tested
        //for (int i=0;i<6; i++) deck.add(new Afflict());              //tested
        ...
        for (int i=0;i<8; i++) deck.add(new DayOfJudgement());       //tested
        ...
        //for (int i=0;i<6; i++) deck.add(new SavorTheMoment());
        //for (int i=0;i<5; i++) deck.add(new VolcanicHammer());       //tested
        //for (int i=0;i<6; i++) deck.add(new WorldAtWar());
